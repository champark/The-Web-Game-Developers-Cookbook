game.things = (function(){
  var items = {
    bat: {
      name: 'bat',
      effects: {
        'player_inventory': { message: "<p>방망이를 선택했습니다!</p>",
                            object: "addItem",
                            subject: "deleteItem"
        },
        'dino': { message: "<p>공룡을 방망이로 내리쳤습니다.</p><p>이제 공룡이 화가 났습니다.</p>",
                  subject: 'deleteItem',
				  object: 'deleteItem',
				  callback: function(){game.screen.callDino()}
        },
        'empty': {
              message: "<p>방망이를 내려놓았습니다..</p>",
              object: "addItem",
              subject: "deleteItem"
        }
      }
    ...
    dino: {
      name: 'dino',
      effects: {
        'player_inventory': { message: "<p>공룡을 움직일 수 없습니다...</p>" } 
      }
    }
  };
